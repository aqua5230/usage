...
- **12 个视觉主题：** 可切换面板风格，包括 Classic、Matrix、Windows 95、Newspaper、Cloud Observation、Midnight Aquarium、Prism Arcade、Black Hole、World Cup 2026、Lepidoptera（蓝图）、彩绘玻璃和折纸。
...
系统托盘图标会随 Claude 配额百分比更新；提示文字会汇总 Claude 和 Codex 的各个窗口。左键通过 WebView2 打开与 macOS 相同的 12 款主题面板（Classic 加另外十一款）；右键可切换面板、刷新、设置开机自启、检查更新和退出。
