...
- **AI更新日報：** AIタレントマーケットのすぐ隣にある専用メニュー項目で、Claude Code、Codex、Antigravityの毎日の更新を確認できます。データは公開の [ai-updates](https://github.com/aqua5230/ai-updates) プロジェクトから取得し、毎日公式changelogを自動で収集します。審査済みの更新は5言語の平易な要約を表示し、未審査のものは公式原文を「平易な要約の審査待ち」として表示します。全履歴は公開[ウェブページ](https://aqua5230.github.io/ai-updates/)で閲覧できます。
