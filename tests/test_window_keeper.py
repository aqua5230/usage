...
def _arm_successful_ping(monkeypatch: pytest.MonkeyPatch, *, enabled: bool = True) -> list[str]:
    ...
    monkeypatch.setattr(window_keeper, "_resolve_claude_bin", lambda: "/fake/claude")
