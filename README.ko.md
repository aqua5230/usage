...
- **AI 업데이트 일보:** AI 인재 마켓 바로 옆의 전용 메뉴 항목에서 Claude Code, Codex, Antigravity의 매일 업데이트를 확인하세요. 데이터는 공개 [ai-updates](https://github.com/aqua5230/ai-updates) 프로젝트에서 가져오며, 매일 공식 changelog를 자동으로 수집합니다. 심사가 완료된 업데이트는 5개 언어의 알기 쉬운 요약을 보여주고, 미심사 항목은 공식 원문을 “알기 쉬운 요약 심사 중”으로 표시합니다. 전체 기록은 공개 [웹 페이지](https://aqua5230.github.io/ai-updates/)에서 볼 수 있습니다.
